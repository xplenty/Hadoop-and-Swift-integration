...
public class SwiftNativeFileSystem extends FileSystem {
   ...
   */
  @Override
  public BlockLocation[] getFileBlockLocations(FileStatus status,
                                               long start,
    ...
    final FileStatus[] listOfFileBlocks = store.listSubPaths(status.getPath(),
                                                             false,
                                                             true);
    ...
    return new BlockLocation[]{
            new BlockLocation(names, hosts, 0, status.getLen())
    };
  }
